...
int main() {
  ...
  *pDyn = 17;
  ...
  SpeakerSystem qss1, qss2, qss3;
  Amplifier qa1, qa2, qa3;
  
  qss1.vibrateSpeakerCones(0);
  qa1.playMusic();
  qa1.attachSpeakers(qss1);
  qa1.playMusic();
  qa1.attachSpeakers(qss2);
  qa1.detachSpeakers();
  qa1.playMusic();
  qa1.attachSpeakers(qss3);
  qa1.playMusic();
  
  cout << "..." << endl;

  qa2.attachSpeakers(qss1);
  qa3.attachSpeakers(qss1);
  qa2.playMusic();
  qa3.playMusic();
  ...
  public:       
    ...
    void movesInWith(Person& newRoomate) {
      if (!roomie && !newRoomate.roomie && &newRoomate != this) {
  ...
  Person oK("O K");
  oK.movesInWith(joeBob);
  
  cout << oK.getName() << " lives with " << oK.getRoomiesName() << endl;
  cout << joeBob.getName() << " lives with " << joeBob.getRoomiesName() << endl;
  cout << billyJane.getName() << " lives with " << billyJane.getRoomiesName() << endl;
}
